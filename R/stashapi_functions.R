...
scrapeSingleStudio <- function(source = NA, input = NA, ...) {
  ...
  fragment ScrapedStudio on ScrapedStudio { ScrapedStudio_stored_id: stored_id ScrapedStudio_name: name ScrapedStudio_urls: urls parent { stored_id name } ScrapedStudio_details: details ScrapedStudio_aliases: aliases tags { stored_id name description alias_list remote_site_id } ScrapedStudio_remote_site_id: remote_site_id }
  ')
...
scrapeSingleTag <- function(source = NA, input = NA, ...) {
  ...
  fragment ScrapedTag on ScrapedTag { ScrapedTag_stored_id: stored_id ScrapedTag_name: name ScrapedTag_description: description ScrapedTag_alias_list: alias_list parent { stored_id name description alias_list remote_site_id } ScrapedTag_remote_site_id: remote_site_id }
  ')
...
scrapeSingleGallery <- function(source = NA, input = NA, ...) {
  ...
  fragment ScrapedGallery on ScrapedGallery { ScrapedGallery_title: title ScrapedGallery_code: code ScrapedGallery_details: details ScrapedGallery_photographer: photographer ScrapedGallery_urls: urls ScrapedGallery_date: date studio { stored_id name } tags { stored_id name description alias_list remote_site_id } performers { ...ScrapedPerformer } }
  fragment ScrapedPerformer on ScrapedPerformer { ScrapedPerformer_stored_id: stored_id ScrapedPerformer_name: name ScrapedPerformer_disambiguation: disambiguation ScrapedPerformer_gender: gender ScrapedPerformer_urls: urls ScrapedPerformer_birthdate: birthdate ScrapedPerformer_ethnicity: ethnicity ScrapedPerformer_country: country ScrapedPerformer_eye_color: eye_color ScrapedPerformer_height: height ScrapedPerformer_measurements: measurements ScrapedPerformer_fake_tits: fake_tits ScrapedPerformer_penis_length: penis_length ScrapedPerformer_circumcised: circumcised ScrapedPerformer_career_start: career_start ScrapedPerformer_career_end: career_end ScrapedPerformer_tattoos: tattoos ScrapedPerformer_piercings: piercings ScrapedPerformer_aliases: aliases tags { stored_id name description alias_list remote_site_id } ScrapedPerformer_images: images ScrapedPerformer_details: details ScrapedPerformer_death_date: death_date ScrapedPerformer_hair_color: hair_color ScrapedPerformer_weight: weight ScrapedPerformer_remote_site_id: remote_site_id }
  ')
...
scrapeSingleImage <- function(source = NA, input = NA, ...) {
  ...
  fragment ScrapedImage on ScrapedImage { ScrapedImage_title: title ScrapedImage_code: code ScrapedImage_details: details ScrapedImage_photographer: photographer ScrapedImage_urls: urls ScrapedImage_date: date studio { stored_id name } tags { stored_id name description alias_list remote_site_id } performers { ...ScrapedPerformer } }
  fragment ScrapedPerformer on ScrapedPerformer { ScrapedPerformer_stored_id: stored_id ScrapedPerformer_name: name ScrapedPerformer_disambiguation: disambiguation ScrapedPerformer_gender: gender ScrapedPerformer_urls: urls ScrapedPerformer_birthdate: birthdate ScrapedPerformer_ethnicity: ethnicity ScrapedPerformer_country: country ScrapedPerformer_eye_color: eye_color ScrapedPerformer_height: height ScrapedPerformer_measurements: measurements ScrapedPerformer_fake_tits: fake_tits ScrapedPerformer_penis_length: penis_length ScrapedPerformer_circumcised: circumcised ScrapedPerformer_career_start: career_start ScrapedPerformer_career_end: career_end ScrapedPerformer_tattoos: tattoos ScrapedPerformer_piercings: piercings ScrapedPerformer_aliases: aliases tags { stored_id name description alias_list remote_site_id } ScrapedPerformer_images: images ScrapedPerformer_details: details ScrapedPerformer_death_date: death_date ScrapedPerformer_hair_color: hair_color ScrapedPerformer_weight: weight ScrapedPerformer_remote_site_id: remote_site_id }
  ')
